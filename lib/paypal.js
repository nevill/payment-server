 ...
 *   respbOj {Object} contains {statusCode, body}
 *      body is a string represented response content
...
Paypal.prototype.remoteCall = function(body, apiPath, callback) {
  ...
  this._httpsRequest(body, options, function(err, respObj, res) {
    var body;
    if (!err) {
...
Paypal.prototype.preapproval = function(options, callback) {
  ...
  _.extend(body, options);
  this.remoteCall(body, Paths.preapproval, callback);
};
...
Paypal.prototype.verify = function(params, callback) {
  ...
  this._httpsRequest(body, options, callback);
};
